...
const [location, setLocation] = useState('');
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pb-16">
        <div className="flex flex-col md:flex-row h-[calc(100vh-160px)] w-full overflow-hidden">
          ...
          <div className="relative w-full md:w-1/2 h-1/2 md:h-full">
            ...
            <div className="relative z-20 flex flex-col justify-center items-center h-full text-white px-8 text-center">
              <h1 className="text-3xl md:text-4xl font-bold">
              Grow and Sell<br /> Fresh & Authentic Produce
              </h1>
              <p className="mt-4">Bringing Nature’s Goodness Directly to You</p>
          ...
          {/* Right Side - Form */}
          <div className="w-full md:w-1/2 flex justify-center items-start bg-gray-100 px-6 py-10 overflow-y-auto max-h-[calc(100vh-160px)]">
  ...
  <div>
    ...
    <select
      ...
      className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:border-black transition duration-150"
      required
    >
